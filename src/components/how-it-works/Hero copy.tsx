    ...
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-primary selection:text-white pb-20">
      ...
      <section className="mt-5  px-5  ">
        <div className=" container mx-auto">
          ...
          <div className="grid grid-cols-1 bg-orange-200 w-full md:grid-cols-3 gap-6 lg:gap-8">
            {infoCards.map((card, index) => (
              <div
                key={card.id}
                className="relative min-h-[80vh] bg-red-500 rounded-[2rem] overflow-hidden group cursor-pointer shadow-lg animate-[fadeInUp_0.8s_ease-out_forwards]"
