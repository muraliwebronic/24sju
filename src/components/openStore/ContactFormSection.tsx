        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <div className="flex flex-col animate-[fadeInUp_0.8s_ease-out_forwards]">
            ...
            <form className="flex flex-col gap-6">
              ...
              {/* Submit Button */}
              <div>
                <button type="submit" className="group bg-primary hover:bg-[#3a782b] text-white rounded-full pl-8 pr-2 py-2 flex items-center gap-6 transition-all duration-300 shadow-md hover:shadow-lg">
