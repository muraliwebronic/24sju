    ...
    <section className="py-20 bg-background overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="relative flex items-center justify-center">
          ...
          <button 
            onClick={handlePrev}
            className="hidden md:flex absolute left-0 lg:-left-12 z-20 w-12 h-12 bg-primary rounded-full items-center justify-center text-white hover:bg-[#3a782b] transition-colors shadow-lg group"
          >
          ...
          {/* Cards Wrapper */}
          <div className="flex gap-6 overflow-x-auto md:overflow-visible no-scrollbar w-full justify-start md:justify-center snap-x snap-mandatory pb-8 md:pb-0">
            ...
            {visiblePosts.map((post, index) => (
              <div 
                ...
                key={`${post.id}-${index}`} 
                className="relative flex-shrink-0 w-[280px] h-[280px] md:w-[320px] md:h-[320px] rounded-3xl overflow-hidden snap-center group cursor-pointer animate-[fadeIn_0.5s_ease-out]"
              >
                <Image
                  src={post.image}
                  alt={post.alt}
          ...
          <button 
            onClick={handleNext}
            className="hidden md:flex absolute right-0 lg:-right-12 z-20 w-12 h-12 bg-primary rounded-full items-center justify-center text-white hover:bg-[#3a782b] transition-colors shadow-lg group"
          >
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="group-hover:translate-x-0.5 transition-transform">
